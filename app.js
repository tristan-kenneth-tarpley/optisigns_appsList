...
class AppsList extends HTMLElement {
    ...
    compiled(){
        ...
        div.innerHTML = `
            <div class="row">
                ...
                <div id="categories" class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="app__search">
                            </div>
                        </div>
                    </div>
                    <br>
                            ...
                            <div class="card linked_card">
                                <div class="card-header">
                                    <div class="card-header_img_container">
                                        <img alt="facebook.png" src="https://static.wixstatic.com/media/e48f7f_004f333f2beb4940ad9ec6128df642b6~mv2.png/v1/fill/w_392,h_392,al_c,q_85,usm_0.66_1.00_0.01/facebook.webp">
                                    </div>
                                </div>
                                <div class="card-body">
                                    <span class="app__title">Title</span>
                                    <p class="app__desc">Testing the description testi</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <span class="app__title">Title</span>
                                    <p class="app__desc">Testing the description testing the description blah blah blah </p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    render(){
        ...
        this.appendChild(this.compiled())
    }
